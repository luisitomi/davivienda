...
export class OrigenService {
  ...
  //TsFAHOrigenCargaContableWS ="https://prod-00-02p-fahise-d01-gxwid5k2w6aee.eastus2.environments.microsoftazurelogicapps.net:443/workflows/df64cec7a27c48d4ac5a2d85125ee9f6/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=xldpRtwM-lQCTyyz5s5hJuGQGbQIyV_62FQ7s_5t9-w";
  ...
  getOrigenes(): Observable<Origen[]> {
    return this.configService.getApiUrl().pipe(
      first(),
      switchMap(url => this.http.get<Origen[]>(this.configService.TsFAHOrigenCargaContableWS)),
    );
  }
  /*
  getOrigenes(): Observable<Origen[]> {
