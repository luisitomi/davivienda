...
![Shared](readme-images/shared-module.png)
...
![Core](readme-images/core-module.png)
...
![routeLink](readme-images/route-link.png)

![urlParams](readme-images/url-params.png)

Ejemplo de navegación en la plantilla con query:

![queries](readme-images/queries.png)

![urlQuery](readme-images/url-queries.png)
...
![observable](readme-images/observable.png)

Se devuelve el subject como observable.

![next](readme-images/next.png)
